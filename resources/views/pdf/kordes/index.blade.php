  ...
  <div class="kontaner ml-3">
    ...
    <table class="table table-hover" width="100%">
      <div class="input-group">
        <form action="/pdf-kordes-detail" method="POST" target="__blank">
          @csrf
          <input type="search" id="inputPassword6" placeholder="Cari Koordinator Desa Dengan ID Koordinator Desa" name="search" class="form-control mt-3" aria-describedby="passwordHelpInline">
        </form>
      </div>
      <div class="row">
        <thead>
